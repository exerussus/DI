...
Поддерживаются приватные поля и свойства, включая унаследованные. **Не** поддерживаются: статические
члены, `readonly`-поля, свойства без сеттера, индексаторы — по каждому случаю бросается исключение
с указанием члена, а не тихо пропускается.
